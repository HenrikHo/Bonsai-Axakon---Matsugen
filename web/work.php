...
<div id="contactWrapper">
    ...
    <div id="contentInputWrapper">
        <div id="">
            <div id="workInputWrapper">
                <input class="workContactClass txtInput" id="workName" placeholder="Name">
                <input class="workContactClass txtInput" id="workEmail" placeholder="Epost du vill bli kontktad på *">
                <textarea class="txtInput" id="contactMessage" placeholder="Meddelande"></textarea>
                <button id="sendMessageButton" onclick="getInfo();"> SKICKA</button>
            </div>
        </div>
    </div>
</div>
